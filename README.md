...
- name: 生活
  type: vless
  server: 64.64.227.248
  port: 36034
  uuid: 07113896-42c3-4d78-86fb-433e5cd95ed7
  tls: true
  udp: true
  network: tcp
  ...
  reality-opts:
    public-key: CLmmRy4WcIGGNmadga1lXQIbjJ9ZRjq7-Xv58aGPNjk
    short-id: 45
...
- DOMAIN-KEYWORD,yunmovie,🍿 Emby
- DOMAIN-KEYWORD,linkedin,🔰 手动选择
...
- DOMAIN-REGEX,^(.*.)?(.*.)?cn.(.*.)?bing.(com|net)$,DIRECT
- DOMAIN-SUFFIX,cn.bing.com,🎯 Direct
- GEOSITE,microsoft,Ⓜ️ Microsoft
- GEOIP,ad,⛔️ 广告拦截
- GEOSITE,category-ads-all,⛔️ 广告拦截
- DOMAIN-SUFFIX,gdt.qq.com,⛔️ 广告拦截
- DOMAIN-SUFFIX,beizi.biz,⛔️ 广告拦截
- DOMAIN-SUFFIX,e.qq.com,⛔️ 广告拦截
- DOMAIN-SUFFIX,umeng.com,⛔️ 广告拦截
- DOMAIN-SUFFIX,doglobal.net,⛔️ 广告拦截
- DOMAIN-SUFFIX,umengcloud.com,⛔️ 广告拦截
- DOMAIN-SUFFIX,yfanads.com,⛔️ 广告拦截
- DOMAIN-SUFFIX,e.kuaishou.com,⛔️ 广告拦截
- DOMAIN-SUFFIX,hubcloud.com.cn,⛔️ 广告拦截
- DOMAIN-SUFFIX,lingsinet.cn,⛔️ 广告拦截
- GEOIP,cn,🎯 Direct
